        ...
        <div className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-white/30 backdrop-blur-xl shadow-2xl border border-white/40">
           ...
           {step === "DETAILS" && (
               <form onSubmit={handleInitiate} className="space-y-4">
                   {/* Name */}
                   <div>
                       <label className="text-slate-700 font-medium text-sm block mb-1">Full Name</label>
                       <div className="relative">
                           ...
                           <input 
                                ...
                                className={`w-full pl-10 pr-4 py-3 rounded-xl bg-white/80 border outline-none shadow-sm transition ${errors.name ? 'border-red-400' : 'border-emerald-200 focus:border-emerald-500'}`}
                           />
                       </div>
                   ...
                   {/* Phone */}
                   <div>
                       <label className="text-slate-700 font-medium text-sm block mb-1">Phone Number</label>
                       <div className="relative">
                   ...
                   {/* Email */}
                   <div>
                       <label className="text-slate-700 font-medium text-sm block mb-1">Email</label>
                       <div className="relative">
                   ...
                   {/* Password */}
                   <div>
                       <label className="text-slate-700 font-medium text-sm block mb-1">Password</label>
                       <div className="relative">
                           ...
                           <input 
                                ...
                                className={`w-full pl-10 pr-12 py-3 rounded-xl bg-white/80 border outline-none shadow-sm transition ${errors.password ? 'border-red-400' : 'border-emerald-200 focus:border-emerald-500'}`}
                           />
                    ...
                    {/* Confirm Password */}
                   <div>
                       <label className="text-slate-700 font-medium text-sm block mb-1">Confirm Password</label>
                       <div className="relative">
                           <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5" />
                           <input 
                                ...
                                className={`w-full pl-10 pr-12 py-3 rounded-xl bg-white/80 border outline-none shadow-sm transition ${errors.confirmPassword ? 'border-red-400' : 'border-emerald-200 focus:border-emerald-500'}`}
                           />
                   ...
                   <div className="text-center mt-4">
                     <Link href="/login" className="text-emerald-700 hover:underline text-sm">
               ...
               <form onSubmit={handleVerify} className="space-y-6">
                    <div className="text-center">
                        <p className="text-sm text-slate-600 mb-4">
                            OTP sent to <span className="font-medium">{formData.email}</span> and <span className="font-medium">+91 {formData.phone}</span>
                        </p>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        >
                         ...
                         <button
                            type="button"
                            onClick={() => {
                                if (resendCooldown === 0) handleInitiate({ preventDefault: () => {} } as any);
                            }}
